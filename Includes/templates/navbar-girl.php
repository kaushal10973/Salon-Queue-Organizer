        ...
        <div class="container">
            <nav class="navbar">
                <a href="#" class="navbar-brand">
                    <img class="salon-logo" style="width: 300px; height: 80px;" src="Design/images/barbershop_girl_logo.jpg" alt="Barbershop Logo">
                </a>
                <div class="d-flex menu-wrap align-items-center main-menu-container">
                    ...
                    <div class="header-btn" style=" margin-left:10px;">
                        <a href="appointment_g.php" class="menu-btn">Make Appointment</a>
                    </div>
                </div>
