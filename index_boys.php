		    ...
		    <div id="home-section-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="Design/images/about-1.jpg" alt="First slide">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="Design/images/about-2.jpg" alt="Second slide">
                        <div class="carousel-caption d-md-block">
                            <h3>It's Not Just a Haircut, It's an Experience.</h3>
                            <p>
                                Our barbershop is the territory created purely for males who appreciate
                    ...
                    <!-- THIRD SLIDE -->
                    <div class="carousel-item">
                        <img class="d-block w-100" src="Design/images/about-3.jpg" alt="Third slide">
                        <div class="carousel-caption d-md-block">
                            <h3>It's Not Just a Haircut, It's an Experience.</h3>
                            <p>
                                Our barbershop is the territory created purely for males who appreciate
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img style="width: 250px; height: 60px;" src="Design/images/barbershop_logo.jpg" alt="Brand">
                        <p>
